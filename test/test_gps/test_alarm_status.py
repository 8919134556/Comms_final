import unittest
from src.gps.alarm_status import AlarmStatus
...
class TestAlarmStatus(unittest.TestCase):
    ...
    def test_invalid_input(self):
        ...
        result = self.alarm_status_processor.hex_bit_alarm_status(context)
        self.assertIsNone(result[0])  # Check if any of the alarm status is None
    ...
    def test_integer_input(self):
        context = "123456"  # Convert integer to string
        result = self.alarm_status_processor.hex_bit_alarm_status(context)
        self.assertIsNone(result[0])  # Check if any of the alarm status is None
